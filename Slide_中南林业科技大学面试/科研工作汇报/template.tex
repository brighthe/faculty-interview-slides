				...
				\begin{tcolorbox}[
					...
					{\fontsize{7.5}{11}\selectfont\sffamily
						...
						\begin{enumerate}
							...
							\item 高阶有限元多分辨率拓扑优化框架，解耦分析网格与设计网格
		...
		\begin{columns}[T, totalwidth=\linewidth]
			...
			\begin{column}{0.50\linewidth}
				\begin{tcolorbox}[
					...
					{\fontsize{7.5}{11}\selectfont\sffamily
						\textbf{发表情况：}\textit{Communications in Computational Physics}, 40(2),
						525‑572.\par
		...
		\begin{columns}[T, totalwidth=\linewidth]
			...
			\begin{column}{0.485\linewidth}
				\begin{tcolorbox}[
					...
					{\fontsize{7.5}{11}\selectfont\sffamily
						\textbf{\circnum{01}\enspace 国家自然科学基金青年科学基金项目}\par
						\vspace{2pt}
						围绕复杂局部约束下的高精度拓扑优化有限元方法，
						凝练高阶/混合有限元与应力约束中的关键科学问题，
						积极申报国家自然科学基金青年科学基金项目。
	...
	\begin{frame}[plain]
		...
		\begin{center}
			...
			\begin{tcolorbox}[
				...
				\centering
				{\fontsize{12}{18}\selectfont\bfseries\sffamily 敬请各位专家老师批评指正！}
			\end{tcolorbox}
